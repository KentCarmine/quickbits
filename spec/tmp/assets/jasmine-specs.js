...
/*! peerjs.min.js build:0.3.5, production. Copyright(c) 2013 Michelle Bu <michelle@michellebu.com> */
...
;
describe("Sender construction", function(){
  it("should create a sender object", function(){
    // expect(new Sender(null)).toBe(instanceof Sender);
