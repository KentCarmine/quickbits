$(document).ready(function(){
  ...
  navigator.sayswho = (function(){
    ...
    if(browserName == 'Chrome' && version >= 31){
      browser.innerHTML = '<p> If file does not transfer you may have been sent a file too large for Chrome to handle. Try <a href = http://www.mozilla.org/en-US/firefox/new/>Firefox</a>.</p>';
    }
   })();
});
